DROP TABLE IF EXISTS cdl.txn_header;
CREATE EXTERNAL TABLE IF NOT EXISTS cdl.txn_header(
 TXN_ID   VARCHAR(32) ,
 TXN_NBR   VARCHAR(40) ,
 BRAND_CD  VARCHAR(5) ,
...
COMMENT 'This is txn_header table in cdl'
ROW FORMAT DELIMITED
FIELDS TERMINATED BY '|'
LINES TERMINATED BY '\n'
STORED AS TEXTFILE
LOCATION '/data/cdl/transactions/txn_header';
