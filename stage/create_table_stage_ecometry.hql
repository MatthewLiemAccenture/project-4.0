DROP TABLE IF EXISTS stage.ecometry;
CREATE EXTERNAL TABLE IF NOT EXISTS stage.ecometry(
SHIP_DATE VARCHAR(8),
...
COMMENT 'This is ecometry table in stage'
ROW FORMAT DELIMITED
FIELDS TERMINATED BY '|'
LINES TERMINATED BY '\n'
STORED AS TEXTFILE
LOCATION '/data/stage/ecometry';
