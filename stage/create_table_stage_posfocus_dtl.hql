DROP TABLE IF EXISTS stage.posfocus_dtl;
CREATE EXTERNAL TABLE IF NOT EXISTS stage.posfocus_dtl(
...
COMMENT 'This is posfocus_dtl table in stage'
ROW FORMAT DELIMITED
FIELDS TERMINATED BY '|'
LINES TERMINATED BY '\n'
STORED AS TEXTFILE
LOCATION '/data/stage/posfocus_dtl';
