DROP TABLE IF EXISTS stage.cs2000_transaction;
CREATE EXTERNAL TABLE IF NOT EXISTS stage.cs2000_transaction(
...
COMMENT 'cs2000 transactions data in stage'
ROW FORMAT DELIMITED
FIELDS TERMINATED BY '|'
STORED AS TEXTFILE
LOCATION '/data/stage/cs2000_transaction';
