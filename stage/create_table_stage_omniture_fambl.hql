DROP TABLE IF EXISTS stage.omniture_fambl;
CREATE EXTERNAL TABLE stage.omniture_fambl(
...
COMMENT 'This is the omniture fambl table in stage layer'
ROW FORMAT DELIMITED 
FIELDS TERMINATED BY '|'
LINES TERMINATED BY '\n'
LOCATION '/data/stage/omniture_fambl';  
