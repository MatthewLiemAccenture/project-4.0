DROP TABLE IF EXISTS stage.ereceipt;
CREATE EXTERNAL TABLE IF NOT EXISTS stage.ereceipt
(
...
COMMENT 'This is ereceipt table in stage'
ROW FORMAT DELIMITED
FIELDS TERMINATED BY '|'
LINES TERMINATED BY '\n'
STORED AS TEXTFILE
LOCATION '/data/stage/ereceipt';
