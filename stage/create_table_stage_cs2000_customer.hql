DROP TABLE IF EXISTS stage.cs2000_customer;
CREATE EXTERNAL TABLE IF NOT EXISTS stage.cs2000_customer
(VIP_NO CHAR(25),
...
COMMENT 'cs2000 customer data in stage'
ROW FORMAT DELIMITED
FIELDS TERMINATED BY '|'
ESCAPED BY '"'
LINES TERMINATED BY '\n'
STORED AS TEXTFILE
LOCATION '/data/stage/cs2000_customer';
