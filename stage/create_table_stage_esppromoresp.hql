DROP TABLE IF EXISTS stage.esppromoresp;
CREATE EXTERNAL TABLE IF NOT EXISTS stage.esppromoresp
(
EMAIL varchar(100),
...
COMMENT 'esppromoresp data in stage'
ROW FORMAT DELIMITED
FIELDS TERMINATED BY '|'
LINES TERMINATED BY '\n'
STORED AS TEXTFILE
LOCATION '/data/stage/esppromoresp';
