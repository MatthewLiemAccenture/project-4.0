DROP TABLE IF EXISTS clientrack_activity;
CREATE EXTERNAL TABLE IF NOT EXISTS stage.clientrack_activity(
...
COMMENT 'This is clientrack_activity table in stage'
ROW FORMAT DELIMITED
FIELDS TERMINATED BY '|'
LINES TERMINATED BY '\n'
STORED AS TEXTFILE
LOCATION '/data/stage/clientrack_activity';
