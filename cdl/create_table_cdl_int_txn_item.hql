DROP TABLE IF EXISTS cdl.int_txn_item;
CREATE EXTERNAL TABLE IF NOT EXISTS cdl.int_txn_item(
...
COMMENT 'This is int_txn_item table in cdl'
ROW FORMAT DELIMITED
FIELDS TERMINATED BY '|'
LINES TERMINATED BY '\n'
STORED AS TEXTFILE
LOCATION '/data/cdl/transactions/int_txn_item';
