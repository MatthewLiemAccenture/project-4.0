DROP TABLE IF EXISTS stage.omniture_fp;
CREATE EXTERNAL TABLE stage.omniture_fp(
...
COMMENT 'This is the omniture fp table in stage layer'
ROW FORMAT DELIMITED 
FIELDS TERMINATED BY '|'
LOCATION '/data/stage/omniture_fp';  
