DROP TABLE IF EXISTS stage.acxespna;
CREATE EXTERNAL TABLE IF NOT EXISTS stage.acxespna
(
EMAIL varchar(100),
...
BATCH_ID VARCHAR(20),
DATE_PROCESSED VARCHAR(100)
)
COMMENT 'acxespna data in stage'
ROW FORMAT DELIMITED
FIELDS TERMINATED BY '|'
LINES TERMINATED BY '\n'
STORED AS TEXTFILE
LOCATION '/data/stage/acxespna';
