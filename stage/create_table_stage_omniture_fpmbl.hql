DROP TABLE IF EXISTS stage.omniture_fpmbl;
CREATE EXTERNAL TABLE stage.omniture_fpmbl(
...
COMMENT 'This is the omniture fpmbl table in stage layer'
ROW FORMAT DELIMITED FIELDS TERMINATED BY '|'
LOCATION '/data/stage/omniture_fpmbl';  
