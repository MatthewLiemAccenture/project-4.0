DROP TABLE IF EXISTS stage.instorenamecapture;
CREATE EXTERNAL TABLE IF NOT EXISTS stage.instorenamecapture
(
TRANSDATE VARCHAR(8),
...
COMMENT 'This is instorenamecapture table in stage'
ROW FORMAT DELIMITED
FIELDS TERMINATED BY '|'
LINES TERMINATED BY '\n'
STORED AS TEXTFILE
LOCATION '/data/stage/instorenamecapture';
